...
Runtime: N/A
Framework: N/A
Primary Use Case: HTTP security headers, CSP nonce, CSRF, XSS, SQL injection, rate limiting, sensitive data, and supply-chain controls
Raw: [2026-04-15-security-baseline.md](../../../raw/engineering/tech-stacks/2026-04-15-security-baseline.md)

## Summary

This baseline captures security controls that apply across web and backend stacks, with implementation details for TanStack Start, Nginx, Drizzle, Better Auth, and dependency supply-chain response.
