...
| Backend: Bun + Elysia | Backend API | Bun | Elysia, Oxc/Oxlint/Oxfmt, OpenAPI 3.1, SaaS admin, JWT/JWKS, RBAC, Drizzle, PgBouncer, Redis, BullMQ, OpenTelemetry, Docker Compose | Current backend API standard | [backend-bun-elysia.md](backend-bun-elysia.md) |
