...
Primary Use Case: Containerized deployment, reverse proxying, secrets, zero-downtime procedures, and scale tiers
Raw: [2026-04-15-infra-docker-compose-nginx-stack.md](../../../raw/engineering/tech-stacks/2026-04-15-infra-docker-compose-nginx-stack.md)

## Summary

This stack defines the Docker Compose and Nginx baseline, Vault-backed secrets, zero-downtime deployment procedure, PgBouncer/Redis infrastructure, and the Kubernetes upgrade path for high concurrency.
