...
Runtime: Bun
Framework: Elysia
Primary Use Case: Standalone APIs, webhook-heavy services, mobile APIs, async workers, and independently deployable backend surfaces
Raw: [2026-04-15-backend-bun-elysia-stack.md](../../../raw/engineering/tech-stacks/2026-04-15-backend-bun-elysia-stack.md)

## Summary

This stack is the current Bun backend API standard. It is intentionally named `backend-bun-elysia` so future backend stacks such as Go or Rust can coexist alongside it.
