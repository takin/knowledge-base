...
Updated: 2026-06-10
Status: Draft
Sources: Internal Tech Stacks draft (2026-04-15, updated 2026-06-10); Internal TanStack Start stack draft (2026-06-04, updated 2026-06-09); Internal standalone repository structure draft (2026-06-09)
Platform: Delivery / quality
Runtime: Bun
Framework: TypeScript + React
Primary Use Case: GitHub Actions pipelines, bundle budgets, static/runtime artifact scans, Docker build checks, and deployment quality gates
Raw: [2026-04-15-ci-cd-typescript.md](../../../raw/engineering/tech-stacks/2026-04-15-ci-cd-typescript.md); [2026-05-22-web-react-vite-stack.md](../../../raw/engineering/tech-stacks/2026-05-22-web-react-vite-stack.md); [2026-06-04-web-tanstack-start-stack.md](../../../raw/engineering/tech-stacks/2026-06-04-web-tanstack-start-stack.md); [2026-06-09-repository-structure-standalone.md](../../../raw/engineering/tech-stacks/2026-06-09-repository-structure-standalone.md)

## Summary

This article defines the CI/CD pipeline for TypeScript projects. GitHub Actions is mandatory. The PR pipeline includes dependency install, formatting, linting, type checking, React tooling diagnostics (when applicable), testing, bundle analysis, Docker build, and static/runtime artifact scans. The merge-to-main pipeline adds E2E tests, image push, and staging deployment.
...
8. TanStack supply-chain guard — fail on affected `@tanstack/*` versions and advisory indicators
