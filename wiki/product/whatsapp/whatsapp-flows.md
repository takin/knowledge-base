...
Interactive Flow messages also appear in Meta's service-message documentation as one of the message types available during an open customer service window.
